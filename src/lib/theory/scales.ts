...
export const SCALES_12: ScaleDef[] = [
  ...
  { label: "Natural Minor (Aeolian)",systemId: "12-TET", pcs: [0,2,3,5,7,8,10] },
...
export const SCALES_24: ScaleDef[] = [
  ...
  { label: "24TET Major (Ionian)",   systemId: "24-TET", pcs: [0,4,8,10,14,18,22] },

  // Example quarter-tone flavors (you can add more later):
  { label: "24TET Neutral Heptatonic", systemId: "24-TET", pcs: [0,4,7,12,16,19,22] },
  { label: "24TET Hijaz-ish",          systemId: "24-TET", pcs: [0,3,10,12,16,18,22] },
];
